  ...
  <q-item class="bg-white q-pt-md" clickable :to="`/posts/${id}`">
    ...
    <q-item-section>
      ...
      <div class="row items-center">
        ...
        <div class="col-3">
          <div class="flex flex-center">
            <PostIcon name="sym_o_visibility" :label="commentCount" tooltip="댓글수"/>
        ...
        <div class="col-3">
          <div class="flex flex-center">
            <q-btn class="full-width" flat dense @click.prevent>
              <PostIcon name="sym_o_visibility" :label="likeCount" tooltip="좋아요"/>
        ...
        <div class="col-3">
          <div class="flex flex-center">
            <q-btn class="full-width" flat dense @click.prevent>
              <PostIcon name="sym_o_visibility" :label="bookmarkCount" tooltip="북마크"/>
            </q-btn>
          </div>
        </div>
      </div>
